...
public class StudentDetails extends JFrame{
	...
	private void initComponents() {
        ...
        Back.setFont(new java.awt.Font("Roboto", 0, 10)); 
        Back.setForeground(new java.awt.Color(0, 204, 255));
        Back.setText("Back");
        Back.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(0, 204, 255)));
        ...
        search.setFont(new java.awt.Font("Roboto", 0, 10));
        search.setForeground(new java.awt.Color(0, 204, 255));
        search.setText("Search");
        search.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(0, 204, 255)));
        ...
        delete.setFont(new java.awt.Font("Roboto", 0, 10));
        delete.setForeground(new java.awt.Color(0, 204, 255));
        delete.setText("Delete");
        delete.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(0, 204, 255)));
	...
	private void ActionPerformed(java.awt.event.ActionEvent evt) {                                       
		try{
			...
			if( evt.getSource() == search){
				String sql = "select * from students where concat(name, student_id) like ?";
				PreparedStatement st = con.c.prepareStatement(sql);
			...
			if(evt.getSource() == delete){
				String sql = "delete from students where name = '" + jTextField1.getText() + "'";
				PreparedStatement st = con.c.prepareStatement(sql);
